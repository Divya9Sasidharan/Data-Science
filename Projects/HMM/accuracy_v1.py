...
#rawCorpus_test="drf/conf 6/drf_conll_test.pkl"
##rawCorpus_out="output_test/conll_conf 6_zeroOrder_output.txt" 
# Accuracy("drf/conf 0/drf_conll_test.pkl", "output_test/conll_conf 0_zeroorder_output.txt")
# Accuracy("drf/conf 1/drf_conll_test.pkl", "output_test/conll_conf 1_zeroorder_output.txt")
# Accuracy("drf/conf 2/drf_conll_test.pkl", "output_test/conll_conf 2_zeroorder_output.txt")
# Accuracy("drf/conf 3/drf_conll_test.pkl", "output_test/conll_conf 3_zeroorder_output.txt")
# Accuracy("drf/conf 4/drf_conll_test.pkl", "output_test/conll_conf 4_zeroorder_output.txt")
# Accuracy("drf/conf 5/drf_conll_test.pkl", "output_test/conll_conf 5_zeroorder_output.txt")
# Accuracy("drf/conf 6/drf_conll_test.pkl", "output_test/conll_conf 6_zeroorder_output.txt")
# Accuracy("drf/conf 0/drf_penn_test.pkl", "output_test/penn_conf 6_secondOrder_output.txt")
#accuracy = Accuracy(rawCorpus_test, rawCorpus_out)

Accuracy("drf/conf 5/drf_genia_test.pkl", "output_test/conll_genia_conf 5_firstorder_output.txt")